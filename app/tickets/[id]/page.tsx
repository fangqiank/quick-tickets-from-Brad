...
import { CloseTicketButton } from '@/app/_components/CloseTicketButton'
...
const TicketDetailsPage = async (props: {
	...
	return (
		<div className='min-h-screen bg-blue-50 p-8'>
			<div className="max-w-2xl mx-auto bg-white rounded-lg shadow border border-gray-200 p-9 space-y-6 ">
